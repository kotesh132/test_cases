...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("parse_ipv6") state parse_ipv6 {
	    ...
	    8w0x0:   parse_ipv6ext_hopbyhop;
    	    ...
    	    8w0x3b:  parse_ipv6ext_nonexthdr;
	    8w0x3c:   parse_ipv6ext_destopts;
            8w0x6: parse_tcp;
            8w0x11: parse_udp;
            default: accept;
        }
    ...
    @name("parse_ipv6ext_hopbyhop") state parse_ipv6ext_hopbyhop {
        bit<8> hdrExtLen =
            packet.lookahead<ipv6exhdr_up_to_hdrextlen_only_t>().hdrExtLen;
        packet.extract(hdr.ipv6ext.next.hopbyhop,
            (bit<32>) (8 * hdrExtLen + 8 ));
    ...
    @name("parse_ipv6ext_destopts") state parse_ipv6ext_destopts {
        bit<8> hdrExtLen =
            packet.lookahead<ipv6exhdr_up_to_hdrextlen_only_t>().hdrExtLen;
        packet.extract(hdr.ipv6ext.next.destopts,
            (bit<32>)  (8 * hdrExtLen + 8));
        transition select (hdr.ipv6ext.last.destopts.nextHdr) {
	    8w0x0:   parse_ipv6ext_hopbyhop;
            8w0x2b:    parse_ipv6ext_routing;
            8w0x3b:  parse_ipv6ext_nonexthdr;
            8w0x3c:   parse_ipv6ext_destopts;
     ...
     @name("parse_ipv6ext_nonexthdr") state parse_ipv6ext_nonexthdr {
        // TBD: Another place where assigning some IP protocol value
        // to a metadata field may be desirable.
        transition accept;
    }
