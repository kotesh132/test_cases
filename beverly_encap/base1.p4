...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("action1") action action1(bit<48> dstAddr, bit<48> srcAddr, bit<16> etherType) {
        hdr.encap_ethernet.dstAddr = dstAddr;
        hdr.encap_ethernet.srcAddr = srcAddr;
        hdr.encap_ethernet.etherType = etherType;
    }
